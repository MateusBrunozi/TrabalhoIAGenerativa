...
CATALOG: dict = {
    ...
    "ASUS": {
        ...
        "modelos": {
            ...
            "ASUS_TUF_A520":       {"label": "TUF Gaming A520M-PLUS II",    "desc": "ASUS TUF Gaming A520 (AMD AM4)",   "filtro": ["asus", "tuf", "a520"]},
            ...
            "ASUS_ROG_B550":       {"label": "ROG STRIX B550-F/E/G",     "desc": "ASUS ROG STRIX B550 (AMD AM4)", "filtro": ["asus", "rog", "strix", "b550"]},
    ...
    "MSI": {
        ...
        "modelos": {
            ...
            "MSI_X570_EDGE":       {"label": "MPG X570 Edge",              "desc": "MSI X570 Gaming Edge/Carbon  (AMD AM4)","filtro": ["msi", "x570", "edge"]},
            "MSI_Z690_TOMAHAWK":   {"label": "MAG Z690 Tomahawk",        "desc": "MSI MAG Z690 Tomahawk  (Intel LGA1700)","filtro": ["msi", "z690", "tomahawk"]},
            "MSI_Z690_EDGE":       {"label": "MPG Z690 Edge",              "desc": "MSI MPG Z690 Gaming Edge  (Intel LGA1700)","filtro": ["msi", "z690", "edge"]},
            "MSI_Z790_TOMAHAWK":   {"label": "MAG Z790 Tomahawk",        "desc": "MSI MAG Z790 Tomahawk  (Intel LGA1700)","filtro": ["msi", "z790", "tomahawk"]},
            "MSI_Z790_EDGE":       {"label": "MPG Z790 Edge",              "desc": "MSI MPG Z790 Gaming Edge  (Intel LGA1700)","filtro": ["msi", "z790", "edge"]},
        },
    },
    ...
    "GIGABYTE": {
        ...
        "modelos": {
            ...
            "GIGA_X570_AORUS":     {"label": "X570 AORUS Master",  "desc": "Gigabyte X570 AORUS  (AMD AM4)",       "filtro": ["gigabyte", "x570", "aorus"]},
            "GIGA_Z690_AORUS":     {"label": "Z690 AORUS Master",  "desc": "Gigabyte Z690 AORUS  (Intel LGA1700)", "filtro": ["gigabyte", "z690", "aorus"]},
            "GIGA_Z690_GAMING":    {"label": "Z690 Gaming X DDR4",  "desc": "Gigabyte Z690 Gaming X  (Intel LGA1700)","filtro": ["gigabyte", "z690", "gaming"]},
            "GIGA_Z790_AORUS":     {"label": "Z790 AORUS Master",  "desc": "Gigabyte Z790 AORUS  (Intel LGA1700)", "filtro": ["gigabyte", "z790", "aorus"]},
        },
    },
    ...
    "DELL": {
        ...
        "tipo":  "notebook",
        "modelos": {
            "DELL_INSPIRON_15":    {"label": "Inspiron 15 5566",  "desc": "Dell Inspiron 15 5566",  "filtro": ["dell", "inspiron", "15"]},
            "DELL_INSPIRON_14":    {"label": "Inspiron 14 5420",  "desc": "Dell Inspiron 14 5420",  "filtro": ["dell", "inspiron", "14"]},
        },
    },
}
...
def get_filtro_rag(marca: str, modelo: str) -> list[str]:
    """Retorna as palavras-chave de filtro RAG para um modelo."""
